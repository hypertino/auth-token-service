...
pomExtra :=
  <url>https://github.com/hypertino/auth-token-service</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/auth-token-service.git</url>
      <connection>scm:git:git@github.com:hypertino/auth-token-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
